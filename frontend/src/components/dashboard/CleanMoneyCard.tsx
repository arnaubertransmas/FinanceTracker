  ...
  return (
    <div className="card bg-gradient-to-br from-base-100 to-base-200 shadow-sm">
      <div className="card-body items-center text-center py-8 gap-1">
        ...
        <span className="text-sm uppercase tracking-wide opacity-60">Money left in your pocket</span>
        ...
        <span className="text-xs opacity-60">Income − expenses (investing doesn&apos;t count against you)</span>

        {!isPositive && (
          <div role="alert" className="alert alert-error py-2 px-3 mt-3 text-sm w-full">
            <AlertTriangle size={16} />
            <span>You&apos;ve spent more than you earned this period.</span>
          </div>
        )}
      </div>
    </div>
